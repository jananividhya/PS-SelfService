...
class Sidebar extends Component {
  ...
  render() {
    ...
    return (
      <div>
         { console.log("innerWidth->",this.props.isCollapseOnButtonClick)}
        <div
          id="sidebar"
          className={(window.innerWidth>991)?(this.props.isCollapseOnButtonClick?("sidebarMinimized sidebar"):"sidebar"):"sidebar"}
          style={{ height: "1000px"}}
          data-color="purple"
          data-image={imagine}
          // onMouseOver={this.handleSidebarMouseEnter}
          //  onMouseOut={this.handleSidebarMouseLeave}
        >
                ...
                if (!prop.redirect && !prop.hidden)
                  return (
                    ...
                    >
                      <NavLink
                        to={prop.path}
                        className={(window.innerWidth>991)?(this.props.isCollapseOnButtonClick?(this.props.hovering?"nav-link":"nav-link-collapsed nav-link" ):"nav-link"):"nav-link"}
                        activeClassName="active"
                      >
                      <div style={{display:"flex",height:"40px"}}>
                        <div className={(window.innerWidth>991)?(this.props.isCollapseOnButtonClick?(this.props.hovering?"icon":"iconCollapsed" ):"icon"):"icon"}>
                        ...
                        {(prop.hasOwnProperty("userName")) &&
                          <p className={(window.innerWidth>991)?(this.props.isCollapseOnButtonClick?(this.props.hovering?"logged-user LinksFontSize":"noFont LinksFontSize" ):"logged-user LinksFontSize"):"logged-user LinksFontSize"}>{prop.userName}</p>}
                          </div>
                          </div>
                      </NavLink>
                    </li>
