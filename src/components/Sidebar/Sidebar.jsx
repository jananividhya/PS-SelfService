...
class Sidebar extends Component {
  ...
  render() {
    ...
    return (
      <div
        id="sidebar"
        className={(this.state.width > 991) ? (this.props.isCollapseOnButtonClick ? ("sidebarMinimized sidebar") : "sidebar") : "sidebar"}
        data-color="purple"
        data-image={imagine}
      >
        {
          console.log("asfafaf", this.props.isCollapseOnButtonClick)
        }
        ...
        <div className="logo">
          ...
          >
            <div className="logo-img">
              <img src="https://test-purpleslate.in/psselfservice/assets/img/psSidebar.png" alt="logo_image" />
            </div>
          </a>
          <a
            href="https://www.creative-tim.com"
        ...
        <div class="user">
          ...
          <div class="info ">
            ...
            <div class="collapse" id="collapseExample" style={{height: "auto"}}>
              <ul class="nav">
                <li>
                  <a class="profile-dropdown" href="https://test-purpleslate.in/psselfservice/index.php/Profile">
        ...
        <div className={(this.state.width > 991) ? (this.props.isCollapseOnButtonClick ? ("sidebar-wrapperMinimized sidebar-wrapper") : "sidebar-wrapper") : "sidebar-wrapper"}>
          <ul className="nav">
          ...
          <div className={(window.innerWidth>991)?(this.props.isCollapseOnButtonClick?"sidebarMic" :"sidebarMic"):"sidebarMic"}>
